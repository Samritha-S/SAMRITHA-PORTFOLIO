...
export function FilteredJourneyTimeline({
  ...
  return (
    <section id="journey-tech" className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="relative border-l border-[var(--border-subtle)] ml-4 sm:ml-32 space-y-12 pl-6 sm:pl-8">
        {milestones.map((item, index) => (
          ...
          >
            ...
            {/* Marker */}
            <div className="absolute -left-[31px] sm:-left-[39px] top-1 w-4 h-4 rounded-sm bg-[var(--bg-base)] border-2 border-[var(--accent-gold)] group-hover:bg-[var(--accent-gold)] group-hover:shadow-[0_0_12px_var(--accent-gold)] transition-all duration-300 flex items-center justify-center">
